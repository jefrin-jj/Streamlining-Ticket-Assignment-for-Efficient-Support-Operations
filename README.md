...
👤 Create Users
Navigate to: All > Users (under System Security)
Click New and fill user details
Submit and repeat for additional users
👥 Create Groups
Go to: All > Groups
Add new groups such as Platform, Certificates
🔐 Create Roles
Navigate to: All > Roles
Add roles like Platform_role, Certificate_role
🗃️ Create Table
...
Navigate to: All > Access Control (ACL)
Add 4 ACLs for table and fields
Require admin role
...
🗃️ Custom Tables and Forms
 ...
 Demo video link 
 https://drive.google.com/file/d/1XA306-F217zpF6iMOuUaGldinaP2ckpH/view?usp=drivesdk
